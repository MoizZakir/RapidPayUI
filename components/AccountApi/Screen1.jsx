...
`
  ...
  return (
    <div style={{}} className='faq-screen1'>
      <h2 style={{ fontWeight: '600' }}>Account API</h2>
      ...
      <div>
        ...
        <p>Postman is an API development tool that helps you to test, document, and share API collections. We will share API collections that will help you to test all the endpoints.</p>
        <p>Please follow these steps to import the collection in your Postman application:</p>
        <ul>
            <li>Click here to download the collection.</li>
            <li>You will find three files, the postman collection, the sandbox environment, and the production environment.</li>
            <li>Open Postman and click on the import button.</li>
            <li>Drag and drop on the popup window the nearpay postman collection file, along with either the sandbox or production environment file based on which environment you will test. You can import all of them if you want.</li>
            <li>Click on the import button, then you will see the collection and inside of it you will find folders, each folder represents an endpoint that has its requests.</li>
            <li>Add your api-key inside the sandbox environment, if you are testing on sandbox environment or add it inside production environment if you are testing on production environment.</li>
        </ul>
        </div>
        <div className='ma1'>
        <h5> Terminals</h5>
