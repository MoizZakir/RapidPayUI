    ...
    rows: [
        {
            ...
            communicate with Rapid
SoftPos when using any function like purchase , refund , etc.`,
        },
        {
            title: "Which package name should I share ?",
            content:
                `You need to share the package name for the Android project with the Rapid
SoftPos team.`,
        },
        {
...
const data2 = {
  ...
  rows: [
      ...
      },
      {
          ...
          content: `Rapid
SoftPos Team will send you a client uuid once we have received the public key and the android package name.
      `,
      },
      {
          title: "When do I need to logout ?",
          content: `When Rapid
SoftPos service is no longer needed . For example when the users logout from your app , they need to logout from Rapid
SoftPos service (means the terminal) as well. So, they cannot use the service when they are logged out .`,
      },
  ],
};
const data3 = {
...
SoftPos Team will send you a client uuid once we have received the public key and the android package name.
      ...
      },
      {
          ...
          content: `Whenever the SDK environment is on production , if the developer mode is
           not off then you can not communicate with Rapid
SoftPos to make any transactions .`,
      },
      {
