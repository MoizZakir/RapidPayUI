       ...
       <p>RapidPay, a Saudi-based fintech startup, has raised $3.6 million in pre-Series
         A funding round led by Vision Ventures, with participation by Hala Ventures, Arzan
          VC, Palm Ventures, and prominent angel investors.  Founded in 2020 by Mohammed Alaiban
           and Hamzah Alghamdi, RapidPay partners with merchants,
         payment providers and startups to enable easy mobile-based soft point of sale services.</p>
         <p>“The field of payments infrastructure is one of the most promising areas in the upcoming years,” Mohammad Alaiban, Co-Founder and CEO of RapidPay, tells StartupScene. “What differentiates this field specifically is the ability to innovate in tailoring payment solutions that suit the local and regional markets without having to depend on ready-made technologies from abroad. This in turn localizes technologies which are in line with the Kingdom’s Vision 2030.”</p>
