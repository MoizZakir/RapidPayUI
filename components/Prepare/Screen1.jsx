...
return jwt.sign(terminal, privateKey, { algorithm: "RS256"});
  ...
  return (
    <div className='prepare-screen1'>
        ...
        <p>To register your package name in Nearpay, follow these steps using the Nearpay dashboard:</p>
        <ol>
            <li>Login to the NearPay dashboard here</li>
      ...
      <p>  AuthenticationData.Email("nearpay@nearpay.io");</p>
       </div>
        </div>
        <div>
            <h5>Allowing your user to login using mobile, email and UserEnter</h5>
        <p>UserEnter, is a way to allow users to enter their mobile number or email to log in. To enable this feature in the Nearpay dashboard, there are a few steps that need to be followed. Once completed, users can log in from the App using their email or mobile number.</p>
        <ol>
            <li>Login to the NearPay dashboard here</li>
        ...
        <ol>
            <li>Login to Nearpay Dashboard.</li>
