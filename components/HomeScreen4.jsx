...
<FaReact  color='gray'size={60} />
     ...
     <div className="homescreen4-section2">
      ...
      <textarea value={text} readOnly={true} style={{backgroundColor:'black' ,color:"white",width:'90%', height:"400px",fontSize:'19px',padding:'20px',borderRadius:'10px',border:'none'
